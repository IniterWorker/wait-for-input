...
int
wfi_gpio_export(int gpio_number, const char *name) {
    char buffer[512];
...
int
wfi_gpio_unexport(int gpio_number) {
    char buffer[512];
...
int
wfi_gpio_direction(int gpio_number, uint8_t direction) {
    char buffer[512];
...
int
wfi_gpio_edge(int gpio_number, uint8_t edge) {
    char buffer[512];
...
int
wfi_gpio_open_value(int gpio_number, struct pollfd *pfd) {
    char buffer[512];
